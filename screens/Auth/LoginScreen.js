...
const SignInScreen = ({navigation}) => {
    ...
    return (
      <View style={styles.container}>
        ...
        >
            <Animatable.View animation="fadeIn" style={{alignSelf:'center',width:50,height:5, backgroundColor:'#1c1e20',marginBottom:20}}/>
            ...
            <TouchableOpacity>
                <Animatable.Text style={{color: '#206cb7', marginTop:15,fontSize:16}}>Forgot password?</Animatable.Text>
            </TouchableOpacity>
