      ...
      <View style={{flex: 3}}>
        <View
          ...
          <View style={{flexDirection: 'row', marginTop: 10}}>
            ...
            <View style={{flex: 2, borderBottomWidth: 0.3}}>
              <Text style={{fontSize: 18}}>Offeretory</Text>
            </View>
            <View style={{flex: 1, alignItems: 'center'}}>
              <Icon name="chevron-right" size={26} />
            </View>
        ...
        <TouchableHighlight style={{backgroundColor: '#fff', marginTop: 20, borderRadius: 20}} onPress = {()=>Alert.alert('alert','Message')} underlayColor = "#cecece">
          <View style={{flexDirection: 'row', marginTop: 10}}>
            <View style={{flex: 1, marginLeft: 20, alignItems: 'flex-start'}}>
              <Icon
                name="information"
